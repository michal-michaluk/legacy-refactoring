...
public class FormEntity {
    ...
    public String toString() {
        return "plan.FormEntity(refNo=" + this.getRefNo() + ", outputPerMinute=" + this.getOutputPerMinute() + ", utilization=" + this.getUtilization() + ", weight=" + this.getWeight() + ", startAndWormUp=" + this.getStartAndWormUp() + ", endAndCleaning=" + this.getEndAndCleaning() + ")";
    }
}

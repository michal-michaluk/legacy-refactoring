...
public class AdjustDemandDto {
    ...
    public String toString() {
        return "logistic.AdjustDemandDto(productRefNo=" + this.getProductRefNo() + ", atDay=" + this.getAtDay() + ", level=" + this.getLevel() + ", deliverySchema=" + this.getDeliverySchema() + ", note=" + this.getNote() + ")";
    }
}
